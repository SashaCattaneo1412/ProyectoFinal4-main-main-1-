...
const connection = mysql.createConnection(process.env.DATABASE_URL='mysql://rglacqiupcibxhfsfe4o:pscale_pw_mv3cHiyDASctbCg2szQgasSNvpC9DtXHZUfwvpAFNcy@aws.connect.psdb.cloud/proyecto?ssl={"rejectUnauthorized":true}');
